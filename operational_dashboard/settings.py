...
SECRET_KEY = '1@_*&-^ndb2@@m39(&=&_%f5t+2hygb$4gn8xrxu(8wfqf^^w@'

ROOT_URLCONF = 'operational_dashboard.urls'
...
ALLOWED_HOSTS = ['operational-dashboard.lizard.net']

try:
    from operational_dashboard.localproductionsettings import *
